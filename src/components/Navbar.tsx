      ...
      <div className="flex items-center justify-between h-full max-w-7xl pl-6 pr-4 mx-auto border-b border-l-0 border-r-0 border-transparent select-none lg:border-r lg:border-l lg:rounded-b-xl">
        ...
        <nav className="relative z-30 flex flex-row-reverse justify-start w-full text-sm sm:justify-end text-neutral-500 dark:text-neutral-400 sm:flex-row">
          ...
          <div
            ...
            } w-full h-auto text-sm sm:text-base sm:h-auto sm:relative sm:flex-row sm:flex sm:text-sm sm:w-auto sm:pr-0 sm:pt-0 sm:gap-[10px]`}
          >
            ...
            {globalConfig.navigation.items
              ...
              .map((item) => (
                <Link
                  ...
                  href={item.href}
                  onClick={closeMenu}
                  className={`relative flex items-center justify-center w-full px-3 py-2 font-medium tracking-wide text-center duration-200 ease-out sm:py-0 sm:mb-0 md:w-auto sm:px-[10px] hover:text-neutral-900 dark:hover:text-white ${
